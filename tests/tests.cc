...
TEST_CASE("Matching engine - fill or kill", "[matchf]") {
  Order o = Order::Builder(OrderType::Limit)
            .SetSide(Side::Sell)
            .SetPrice(500)
            .SetQuantity(100)
  ...
  Order o2 = Order::Builder(OrderType::FillOrKill)
            .SetSide(Side::Buy)
            .SetPrice(500)
            .SetQuantity(100)
            .Build();
  ...
  Order o4 = Order::Builder(OrderType::FillOrKill)
            .SetSide(Side::Buy)
            .SetPrice(100)
            .SetQuantity(190)
            .Build();
  ...
  Order o5 = Order::Builder(OrderType::Limit)
            .SetSide(Side::Buy)
            .SetPrice(200)
            .SetQuantity(100)
            .Build();
  
  Order o6 = Order::Builder(OrderType::FillOrKill)
            .SetSide(Side::Sell)
            .SetPrice(200)
            .SetQuantity(100)
            .Build();
